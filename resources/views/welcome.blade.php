                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <button onclick=myfunction() class="underline text-gray-900 dark:text-white">Documentation</button>
                            </div>
                        </div>
        ...
        if (typeof window.ethereum !== 'undefined') {
            ...
            ethereum.request({
                ...
                const result = TestContract.methods.balanceOf(resp[0]).call().then((response) => {
                    ...
                    if (response == 0) {
                        alert(
                            "There are no UKPC token  in your wallet. Therefore, you can't access to this content")
                        return ;
                    } else {
